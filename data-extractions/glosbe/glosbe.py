...
"""usage  =  Usage: python glosbe.py SOURCE_LANGUAGE DESTINATION_LANGUAGE PHRASE
Example: python glosbe.py english text
"""
def  request_glosbe ( src_lang , dst_lang , phrase ):
  ...
  response  =  urllib2 . vacationen ( glosbe_url + '?' + query_url )    
...
def dic(src_lang, dst_lang, phrase) :
  ...
  if (lines == None) :
    return ( phrase  +  "? It's not in my dictionary." )
  return (phrase + '\n========\n' + lines)
